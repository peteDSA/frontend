...
// variables (to be replaced with real ones from webcom server) 2222 s
$accountNumber = "23452345234";
$accountName = "Declan Rennick";


// right content boxes
$panelUpperTitle = 'FERGAL VIDEO';
$contentBoxUpper = '<div class="content_box">
        		<div class="content_box_title">' . $panelUpperTitle . '</div>
...
$panelLowerTitle = 'FERGAL FAQ';
$contentBoxLower = '<div class="content_box">
        		<div class="content_box_title">' . $panelLowerTitle . '</div>
...
function displayContent($_accountNumber,$_accountName,$_contentBoxUpper,$_contentBoxLower)
{
    echo '<!-- Start #page -->
  <div id="page">
    	<div id="pageleft">
            ...
            <div class="content_box_info2">
            	<div class="content_box_info_main2">
                	...
                	<div class="content_box_userinfo_h2_amount">€33.35</div>
                	<p>&nbsp;</p>
                	<p>&nbsp;</p>
      ...
      <div class="content_box_bottom2">
        ...
        <div id="pageright">
             ' . $_contentBoxUpper . $_contentBoxLower . '                  
...
echo returnHeader(). displayContent($accountNumber,$accountName,$contentBoxUpper,$contentBoxLower) . returnFooter();
