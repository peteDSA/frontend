...
function displayContent($_accountNumber,$_accountName)
{
    echo '<!-- Start #page -->
  <div id="page">
    	<div id="pageleft">
            ...
            <div class="content_box_account_name2">' . $_accountName . 'LOGI</div>
            <div class="content_box_account_number2">Acc. No. include 'footer.php';</div>
            </div>
...
echo returnHeader(). displayContent($accountNumber,$accountName) . returnFooter();
